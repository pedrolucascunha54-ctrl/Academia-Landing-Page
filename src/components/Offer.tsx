...
export default function Offer() {
  return (
    <>
      <ScrollVideoSection
        video="/videos/oferta.mp4"
        direction="left"
        eyebrow="Sua vez"
        heading="Comece agora sua jornada criando e vendendo sites com IA"
      >
        <p className="max-w-md text-base leading-relaxed text-muted sm:text-lg">
          Curso completo, bônus e comunidade — tudo liberado assim que você entra.
        </p>
        <a
          href={CHECKOUT_URL}
          className="mt-2 inline-flex w-fit items-center gap-2 rounded-full bg-gradient-to-r from-neon to-violet px-7 py-3.5 text-sm font-bold text-[#020611] shadow-[0_0_30px_rgba(0,191,255,0.4)] transition-transform hover:scale-105"
        >
          QUERO ENTRAR AGORA
        </a>
      </ScrollVideoSection>
