    ...
    <section className="relative w-full py-20">
      <Container>
        <Reveal className="mx-auto flex max-w-3xl flex-col items-center gap-6 rounded-3xl border border-cyan/20 bg-gradient-to-br from-cyan/5 to-violet/5 p-8 text-center sm:flex-row sm:text-left sm:p-10">
          <div className="relative flex h-24 w-24 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-neon to-violet shadow-[0_0_40px_rgba(0,191,255,0.4)]">
            <div className="flex h-[88px] w-[88px] items-center justify-center rounded-full bg-[#020611]">
